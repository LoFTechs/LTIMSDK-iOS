...
- (void)queryChannelWithTransID:(NSString * _Nonnull)transID chID:(NSString * _Nonnull)chID withMembers:(BOOL)withMembers completion:(void (^_Nullable)(LTQueryChannelsResponse *response, LTErrorInfo * _Nullable error))completion;
- (void)queryChannelWithTransID:(NSString * _Nonnull)transID chTypes:(NSSet<NSNumber *> * _Nonnull)chTypes batchCount:(NSUInteger)batchCount withMembers:(BOOL)withMembers completion:(void (^_Nullable)(LTQueryChannelsResponse *response, LTErrorInfo * _Nullable error))completion;
- (void)queryChannelWithTransID:(NSString * _Nonnull)transID lastUpdateTime:(long long)lastUpdateTime batchCount:(NSUInteger)batchCount withMembers:(BOOL)withMembers completion:(void (^_Nullable)(LTQueryChannelsResponse *response, LTErrorInfo * _Nullable error))completion;
- (void)queryCorpChannelListWithTransID:(NSString * _Nonnull)transID lastUpdateTime:(long long)lastUpdateTime completion:(void (^_Nullable)(LTQueryChannelsResponse *response, LTErrorInfo * _Nullable error))completion;
- (void)queryChannelReadInfoWithTransID:(NSString * _Nonnull)transID chID:(NSString * _Nonnull)chID completion:(void (^_Nullable)(LTQueryChannelReadInfoResponse *response, LTErrorInfo * _Nullable error))completion;
- (void)queryChannelReadTimeWithTransID:(NSString * _Nonnull)transID chID:(NSString * _Nonnull)chID completion:(void (^_Nullable)(LTQueryChannelsReadTimeResponse *response, LTErrorInfo * _Nullable error))completion;
- (void)queryChannelsReadTimeWithTransID:(NSString * _Nonnull)transID lastChID:(NSString * _Nonnull)lastChID lastChType:(LTChannelType)lastChType count:(NSUInteger)count completion:(void (^_Nullable)(LTQueryChannelsReadTimeResponse *response, LTErrorInfo * _Nullable error))completion;
- (void)queryUnreadChannelsWithTransID:(NSString * _Nonnull)transID completion:(void (^_Nullable)(LTQueryUnreadChannelsResponse *response, LTErrorInfo * _Nullable error))completion;
- (void)queryChannelMembersWithTransID:(NSString * _Nonnull)transID chID:(NSString * _Nonnull)chID lastUserID:(NSString * _Nonnull)lastUserID count:(NSUInteger)count completion:(void (^_Nullable)(LTQueryChannelMembersResponse *response, LTErrorInfo * _Nullable error))completion;
